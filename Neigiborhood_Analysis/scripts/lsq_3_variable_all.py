...
if __name__ == '__main__':
    ...
    #input rasters
    ent_dict = {'R02028':r"C:\workspace\GLCM\Neigiborhood_Analysis\GLCM_Rasters\R02028_3_entropy_Resampled.tif"}
    ...
    for (k,v), (k1,v1), (k2,v2) in zip(ent_dict.items(),var_dict.items(), homo_dict.items()):
        ...
        outFile = r"C:\workspace\GLCM\Neigiborhood_Analysis\Sedclass_Rasters" + os.sep + k +"_median_Sed_Class_3_variable.tif"
        #======================================================
        ## inputs
