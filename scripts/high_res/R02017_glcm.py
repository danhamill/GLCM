...
if __name__ == '__main__':  
    ...
    for win_size in win_sizes[1:2]:   
        in_raster = r"C:\workspace\Reach_3\2015_04\ss_2015_04_R02017_clipped.tif"
        win = win_size
        meter = str(win/4)
        print 'Now working on %s meter grid...' %(meter,)
        contFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2015_04" + os.sep+ "R02017_" + meter + "_contrast.tif"
        dissFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2015_04" + os.sep+"R02017_" + meter + "_diss.tif"
        homoFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2015_04" + os.sep +"R02017_" + meter + "_homo.tif"
        energyFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2015_04" + os.sep +"R02017_" + meter + "_energy.tif"
        corrFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2015_04" + os.sep + "R02017_" + meter + "_corr.tif"
        ASMFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2015_04" + os.sep +"R02017_" + meter + "_asm.tif"
        ENTFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2015_04" + os.sep + "R02017_" + meter + "_entropy.tif"
        meanFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2015_04" + os.sep + "R02017_" + meter + "_mean.tif"
        varFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2015_04" + os.sep + "R02017_" + meter + "_var.tif"
