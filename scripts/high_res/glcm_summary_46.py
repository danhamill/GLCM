...
if __name__ == '__main__':  
    ...
    for win_size in win_sizes[1:2]:   
        ...
        contFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04" + os.sep + meter +os.sep+"R01346_R01347_" + meter + "_contrast.tif"
        dissFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04" + os.sep + meter +os.sep+"R01346_R01347_" + meter + "_diss.tif"
        homoFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04" + os.sep + meter +os.sep+"R01346_R01347_" + meter + "_homo.tif"
        energyFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04" + os.sep + meter +os.sep+"R01346_R01347_" + meter + "_energy.tif"
        corrFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04" + os.sep + meter +os.sep+"R01346_R01347_" + meter + "_corr.tif"
        ASMFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04" + os.sep + meter +os.sep+"R01346_R01347_" + meter + "_asm.tif"    
        ENTFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04" + os.sep + meter +os.sep+"R01346_R01347_" + meter + "_entropy.tif"
        meanFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04" + os.sep + meter +os.sep+"R01346_R01347_" + meter + "_mean.tif"
        varFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04" + os.sep + meter +os.sep+"R01346_R01347_" + meter + "_var.tif"
        ...
        for raster in raster_list:
            ...
            oName = r"C:\workspace\GLCM\new_output\2014_04" + os.sep + variable + "_aggragrated_" + meter +"_distribution.csv"
            agg_tbl.to_csv(oName,sep=',')
            oName = r"C:\workspace\GLCM\new_output\2014_04" + os.sep + variable + "_aggragrated_" + meter +".png"
            ...
            oName = r"C:\workspace\GLCM\new_output\2014_04" + os.sep + variable + "_zonalstats_" + meter +"_grid.csv" 
            ...
            oName = r"C:\workspace\GLCM\new_output\2014_04" + os.sep + variable + "_ss_comparison_" + meter +".csv"   
            merge.to_csv(oName, sep=',', index=False)
            
            
            oName = r"C:\workspace\GLCM\new_output\2014_04" + os.sep + variable + "_ss_comparison_" + meter +".png"
