...
if __name__ == '__main__':  
    ...
    for win_size in win_sizes[1:2]:   
        ...
        for raster in raster_list[:]:
            ...
            oName = r"C:\workspace\GLCM\new_output\2014_09_2" + os.sep + variable + "_aggragrated_" + meter +"_distribution.csv"
            agg_tbl.to_csv(oName,sep=',')
            
            oName = r"C:\workspace\GLCM\new_output\2014_09_2" + os.sep + variable + "_aggragrated_" + meter +".png"

            plot_agg_table(agg_tbl,oName, meter)
            
            oName = r"C:\workspace\GLCM\new_output\2014_09_2" + os.sep + variable + "_aggragrated_" + meter +"_distribution.png"
            ...
            oName = r"C:\workspace\GLCM\new_output\2014_09_2" + os.sep + variable + "_zonalstats_" + meter +"_grid.csv" 
            ...
            oName = r"C:\workspace\GLCM\new_output\2014_09_2" + os.sep + variable + "_ss_comparison_" + meter +".csv"   
            merge.to_csv(oName, sep=',',index=False)
            
            oName = r"C:\workspace\GLCM\new_output\2014_09_2" + os.sep + variable + "_ss_comparison_" + meter +".png"
