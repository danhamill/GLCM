...
if __name__ == '__main__':
    ...
    cont_raster = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_09\3\R01767_3_contrast_resampled.tif"
    ...
    for df in [p_25,p_50,p_75]:
        ...
        if df.equals(p_25):
            ...
            metric = 'percentile75'
        outFile = r"C:\workspace\GLCM\output\least_sqares_classification\R01767_"+metric+"_Sed_Class_4_variable.tif"
