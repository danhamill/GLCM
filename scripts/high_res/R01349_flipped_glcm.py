...
if __name__ == '__main__':  
    ...
    for win_size in win_sizes[1:2]:   
        in_raster =  r"C:\workspace\Reach_4a\Multibeam\mb_sed_class\may2014_mb6086r_sedclass\ss_R01349_flipped.tif"
        win = win_size
        meter = str(win/4)
        print 'Now working on %s meter grid...' %(meter,)
        contFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04" + os.sep+ "R01349_flipped" + meter + "_contrast.tif"
        dissFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04" + os.sep+"R01349_flipped" + meter + "_diss.tif"
        homoFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04" + os.sep +"R01349_flipped" + meter + "_homo.tif"
        energyFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04" + os.sep +"R01349_flipped" + meter + "_energy.tif"
        corrFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04" + os.sep + "R01349_flipped" + meter + "_corr.tif"
        ASMFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04" + os.sep +"R01349_flipped" + meter + "_asm.tif"
        ENTFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04" + os.sep + "R01349_flipped" + meter + "_entropy.tif"
        meanFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04" + os.sep + "R01349_flipped" + meter + "_mean.tif"
        varFile = r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04" + os.sep + "R01349_flipped" + meter + "_var.tif"
