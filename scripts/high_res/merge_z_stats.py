...
files_04 = glob(r"C:\workspace\GLCM\new_output\2014_04\*zonalstats*csv")
files_09 = glob(r"C:\workspace\GLCM\new_output\2014_09\*zonalstats*csv")
files_09_2 = glob(r"C:\workspace\GLCM\new_output\2014_09_2\*zonalstats*csv")
n = 0
