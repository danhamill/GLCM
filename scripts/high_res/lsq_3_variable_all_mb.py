...
if __name__ == '__main__':
    ...
    #input rasters
    ent_dict = {'R01349':r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04\R01349_flip_resampled_entropy.tif"}      
                
    var_dict = {'R01349':r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04\R01349_flip_resampled_var.tif" }   
    
    homo_dict = {'R01349':r"C:\workspace\GLCM\output\new_glcm_rasters\2014_04\R01349_flip_resampled_homo.tif"}  
    ...
    for (k,v), (k1,v1), (k2,v2) in zip(ent_dict.items(),var_dict.items(), homo_dict.items()):
        ...
        del k, k1, k2, v1, v, v2, sed_class, sed_df, sand_conf, rock_conf, gravel_conf,prc_sand,prc_gravel,prc_rock,ss_resid,vec1,vec2,vec3,homo_data,var_data,ent_data,ind,gt,Nx,Ny,ent_raster,homo_raster,var_raster

    #classification results       
    rasters = [outFile]
    shps = [r"C:\workspace\Reach_3\2015_04\r3_substrates.shp"]
