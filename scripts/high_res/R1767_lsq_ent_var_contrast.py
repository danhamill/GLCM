...
if __name__ == '__main__':
    ...
    #25% ranges
    p_25 = get_center(cont_df,var_df,ent_df,'percentile_25')
    p_50 = get_center(cont_df,var_df,ent_df,'percentile_50')
    p_75 = get_center(cont_df,var_df,ent_df,'percentile_75')
    df = p_50
    for df in [p_25,p_50,p_75]:
        ...
        if df.equals(p_25):
            ...
            metric = 'percentile75'
        outFile = r"C:\workspace\GLCM\output\least_sqares_classification\R01346_R01347_"+metric+"_Sed_Class_3class_cont.tif"
        ...
        plt.imshow(gravel_conf);plt.colorbar();plt.show()
